...
function preload() {
  ...
  img[1] = loadImage('menuimg.gif');
  img[2] = loadImage('int.gif');
  img[3] = loadImage('front_monster-removebg-preview.png');
  img[4] = loadImage('maxresdefault.png');
  img[5] = loadImage('gameover.gif');
  img[6] = loadImage('st01.gif');
  img[7] = loadImage('Xg+Ruo.png');
  img[8] = loadImage('825L (1).gif');
  img[9] = loadImage('castle01.jpg');
  img[10] = loadImage('Xucp (1).gif');
  img[11] = loadImage('Castle4.jpg');
  img[12] =loadImage('c7c6e02f08c9f741676e6c6b3788d5e0.png');
  ...
  img[13] =loadImage('200a002dad331dc9d5027bc45cf03f1d.png')
  msc[1] = loadSound('WhatsApp-Audio-2020-12-09-at-4.10.14-PM.mp3');
  msc[2] = loadSound('WhatsApp-Audio-2020-12-09-at-4.10.15-PM.mp3');
  msc[3] = loadSound('y2mate.com - Naruto - Sadness and Sorrow 8 Bit_320kbps (1).mp3');
  msc[4] = loadSound('the_wind_forest_joe_hisaishi_-1069538542516541606.mp3');
  msc[5] = loadSound('mega_man_x8_booster_forest_8_bit_famitracker_-4580667608125995447.mp3');
  msc[6] = loadSound('WhatsApp-Audio-2020-12-09-at-4.10.15-PM-1.mp3');
  msc[7] = loadSound('mattashi_the_final_battle_epic_8_bit_orchestral_battle_-1947069715994614696.mp3');
}
function setup() {
...
if(dist(xmonster1+326,ymonster1+200,xjogador+20,yjogador+217) < (6*rmonster1+3*rjogador)) {
  ...
  if(keyCode === 68){
      if (keyIsPressed === true&& xjogador<430){
  ...
  if(keyCode === 65){
   if (keyIsPressed === true&& xjogador>10){
...
if(dist(xmonster1+326,ymonster1+200,xjogador+20,yjogador+217) < (6*rmonster1+3*rjogador)) {
  ...
  if(tempo>10) {
    ...
    if(bonequinho==true){
         image(linku1D[contador%3],xjogador,yjogador+230,largura-130,altura-20);
  if(tempo>5) {
     contador++;
     tempo=0;
...
if(dist(xmonster1+200,ymonster1+100,xjogador+20,yjogador+200) < (7*rmonster1+5*rjogador)) {
  ...
  if(keyCode === 65){
   if (keyIsPressed === true&&xjogador>30) {
  ...
  if(tempo>10) {
    ...
    if(bonequinho==true){
         image(linku1D[contador%3],xjogador,yjogador+205,largura-130,altura-20);
  if(tempo>5) {
     contador++;
     tempo=0;
